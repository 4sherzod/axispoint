...
<body>
    ...
    <div id="companyDiv" class="sectionforbar companyClass">
        <div> 
            ...
            <p>At Axis Point, we recognize that securing the right banking solutions is critical for the smooth operation and success of any business. Whether you're setting up a new venture or looking to expand an existing enterprise, navigating the banking landscape can be complex, especially across different jurisdictions. Our banking solutions are designed to simplify this process, ensuring you have access to the best financial services tailored to your specific business needs.</p>
        </div>
    ...
    <div id="companyInfoDiv" class="companyClass"> 
        ...
        <p>We offer a full range of banking services aimed at facilitating both local and international business operations. Our team of experts works closely with you to understand your financial requirements and match you with the right banking partners. From opening a corporate bank account to establishing trade finance and managing treasury operations, Axis Point is your trusted partner in securing optimal financial arrangements.<p>
        <br>
